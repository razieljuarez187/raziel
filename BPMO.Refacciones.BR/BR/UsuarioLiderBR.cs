...
namespace BPMO.Refacciones.BR {
    /// <summary>
    /// Reglas de negocio para UsuarioLider
    /// </summary>
    public class UsuarioLiderBR {
        #region Atributos
        ...
        /// <summary>
        /// Obtiene una lista de Usuarios Líder
        /// </summary>
        ...
        public List<CatalogoBaseBO> Consultar(IDataContext dataContext, CatalogoBaseBO catalogoBase) {
            UsuarioLiderConsultarDAO consultarDAO = new UsuarioLiderConsultarDAO();
