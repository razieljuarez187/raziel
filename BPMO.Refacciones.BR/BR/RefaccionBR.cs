...
namespace BPMO.Generales.BR {
    /// <summary>
    /// Servicios para la manipulación del catálogo de refacciones
    /// </summary>
    public class RefaccionBR : IBRBaseCatalogo {
        #region Atributos
        ...
        public List<CatalogoBaseBO> Consultar(IDataContext dataContext, CatalogoBaseBO catalogoBase) {
            try {
                RefaccionConsultarDAO consultarDAO = new RefaccionConsultarDAO();
