...
namespace BPMO.Refacciones.Procesos.VIS {
    /// <summary>
    /// Vista para el mantenimiento de Configuración Transferencia
    /// </summary>
    public interface IBuscadorConfiguracionTransferenciasVIS {
        #region Propiedades
        /// <summary>
        ...
        /// </summary>
        List<ConfiguracionTransferenciaBO> ListadoConfiguracionTransferencia { get; set; }
        #endregion
