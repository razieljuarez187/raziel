<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BuscadorUI.aspx.cs" Inherits="BPMO.Buscador.Web.BuscadorUI" %>
...
<head runat="server">
    ...
    <script src="../../Script/jquery.jlabel-1.3.min.js" type="text/javascript"></script>
    <style type="text/css">
        .BotonReset
        {
            margin: 3px 15px 0;
        ...
        function InitControls() {
            ...
            if ($("#<%=grdBuscador.ClientID%>")[0].rows.length > 1) {
                ...
                jQuery.each(arrHeader, function (index, value) {
                    ...
                    txt.css("width", ($(value).find("span").length == 0) ? ((txt.width() >= 300) ? '90%' : '70%') : '40%');
                    tr.append(value);
                });
                arrBusca.before(tr);
            } else {
...
<body style="font-size: 11px;">
    ...
    <script src="../../Script/jPage.BlockUI.js" type="text/javascript"></script>
